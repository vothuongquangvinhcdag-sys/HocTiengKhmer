...
const Game5 = ({ navigate, path }) => {
  /* =======================================================
     ĐIỀU HƯỚNG STAGE
  ======================================================= */

  if (path === "/game/5/stage/1") {
    return <Stage1 navigate={navigate} />;
  }

  if (path === "/game/5/stage/2") {
    return <Stage2 navigate={navigate} />;
  }

  if (path === "/game/5/stage/3") {
    return <Stage3 navigate={navigate} />;
  }

  if (path === "/game/5/stage/4") {
  ...
  const stage1Completed =
    isStageCompleted(5, 1);

  const stage2Completed =
    isStageCompleted(5, 2);

  const stage3Completed =
    isStageCompleted(5, 3);

  const stage4Completed =
    isStageCompleted(5, 4);
